...
ALTER TABLE `atlassian_resource` ALTER COLUMN "created_at" TO "created_at" text NOT NULL DEFAULT (current_timestamp);--> statement-breakpoint
...
CREATE INDEX `idx_scheduled_job_issue_test_case_modified_by` ON `scheduled_job_issue_test_case` (`modified_by_user_id`);--> statement-breakpoint
ALTER TABLE `atlassian_resource` ALTER COLUMN "updated_at" TO "updated_at" text NOT NULL DEFAULT (current_timestamp);--> statement-breakpoint
ALTER TABLE `jira_project` ALTER COLUMN "created_at" TO "created_at" text NOT NULL DEFAULT (current_timestamp);--> statement-breakpoint
ALTER TABLE `jira_project` ALTER COLUMN "updated_at" TO "updated_at" text NOT NULL DEFAULT (current_timestamp);--> statement-breakpoint
ALTER TABLE `jira_project_compliance` ALTER COLUMN "created_at" TO "created_at" text NOT NULL DEFAULT (current_timestamp);--> statement-breakpoint
ALTER TABLE `jira_project_compliance` ALTER COLUMN "updated_at" TO "updated_at" text NOT NULL DEFAULT (current_timestamp);--> statement-breakpoint
ALTER TABLE `jira_project_issue_type` ALTER COLUMN "created_at" TO "created_at" text NOT NULL DEFAULT (current_timestamp);--> statement-breakpoint
ALTER TABLE `jira_project_issue_type` ALTER COLUMN "updated_at" TO "updated_at" text NOT NULL DEFAULT (current_timestamp);--> statement-breakpoint
ALTER TABLE `user_atlassian_project_access` ALTER COLUMN "created_at" TO "created_at" text NOT NULL DEFAULT (current_timestamp);--> statement-breakpoint
ALTER TABLE `user_atlassian_project_access` ALTER COLUMN "updated_at" TO "updated_at" text NOT NULL DEFAULT (current_timestamp);--> statement-breakpoint
ALTER TABLE `scheduled_job` ALTER COLUMN "created_at" TO "created_at" text NOT NULL DEFAULT (current_timestamp);--> statement-breakpoint
ALTER TABLE `scheduled_job` ALTER COLUMN "updated_at" TO "updated_at" text NOT NULL DEFAULT (current_timestamp);--> statement-breakpoint
ALTER TABLE `scheduled_job_issue` ALTER COLUMN "created_at" TO "created_at" text NOT NULL DEFAULT (current_timestamp);--> statement-breakpoint
ALTER TABLE `scheduled_job_issue` ALTER COLUMN "updated_at" TO "updated_at" text NOT NULL DEFAULT (current_timestamp);--> statement-breakpoint
ALTER TABLE `scheduled_job_issue_test_case` ALTER COLUMN "created_at" TO "created_at" text NOT NULL DEFAULT (current_timestamp);--> statement-breakpoint
ALTER TABLE `scheduled_job_issue_test_case` ALTER COLUMN "updated_at" TO "updated_at" text NOT NULL DEFAULT (current_timestamp);