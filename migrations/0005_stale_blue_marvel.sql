...
--> statement-breakpoint
INSERT INTO `__new_scheduled_job_issue`("id", "job_id", "issue_id", "issue_key", "summary", "description", "issue_type_id", "status", "created_at", "updated_at") SELECT "id", "job_id", "issue_id", "issue_key", "summary", "description", "issue_type_id", "status", "created_at", "updated_at" FROM `scheduled_job_issue`;--> statement-breakpoint
