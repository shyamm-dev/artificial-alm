...
interface StandaloneTestCaseAccordionProps {
  testCase: StandaloneTestCase
  isModified: boolean
  isNew: boolean
  isSelected: boolean
  onToggleSelect: (id: string) => void
  onUpdate: (id: string, field: keyof StandaloneTestCase, value: string) => void
...
export function StandaloneTestCaseAccordion({
  testCase,
  isModified,
  isNew,
  isSelected,
  ...
  onDelete,
  validationError
}: StandaloneTestCaseAccordionProps) {
          ...
          {isEditing ? (
            ...
            <>
              ...
              <div className="flex justify-end gap-2 pt-2 border-t">
                {isModified && !isNew && (
                  <Button size="sm" variant="outline" onClick={() => onReset(testCase.id)}>
